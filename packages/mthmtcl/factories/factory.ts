...
/**
 * Represents a math function generated by a factory. Each
 * math function is garaunteed to have, at least, the capability
 * of converting its Params into an instance of the {@link TreeNode}
...
/**
 * Utility type for mapping a generic TreeNode type to its normal
 * parameters. This specifically will map {@link UnaryNode} to
 * `[TreeNode]`, and {@link BinaryNode} to `[TreeNode, TreeNode]`
 */
